  ...
  return (
    <>
      <div className="w-full min-h-screen flex justify-center items-center bg-[#FFF8E7]">
        <div className="w-[92%] max-w-300 bg-white rounded-4xl shadow-[0_8px_30px_rgba(0,0,0,0.03)] min-h-170 flex flex-col relative">
          {/* NAVBAR */}
          <nav className="w-full  h-25.5   rounded-t-[28px] shadow-[0px_6px_30.1px_rgba(186,185,185,0.25)] relative">
              ...
              <div className="flex gap-4 absolute top-60">
                ...
                {open && (
                  <div className="fixed inset-0 flex items-center justify-center bg-black/30 z-50">
                    {/* Modal */}
                    <div className="flex items-center justify-center w-237.25 h-127.75 bg-[#FFFCEE] rounded-[20px] shadow-xl p-8 relative">
                      <div className="relative bg-[#FAFAFA] w-225 h-114.75 flex flex-col items-center rounded-[20px] p-10 shadow-[4px_4px_4px_rgba(191,191,191,0.25)]">
                        <button
                        ...
                        <h2 className="text-[32px] font-semibold text-center pb-2 top-12.5">
                          Welcome back, {session?.user?.name}!
                        </h2>

                        <div className="w-175 h-px bg-gray-300 mb-4 absolute top-22.5"></div>

                        <p className=" text-center text-[20px] mb-12 absolute top-27.5">
                          Choose what you&apos;d like to do next
                        </p>

                        <div className="flex gap-14 absolute top-45">

                          <button
                            className="flex flex-col items-center justify-center bg-[#E9F3E8] border-[5px] border-[#D4F4E6] rounded-2xl p-6 w-72.5 h-50 shadow hover:bg-green-200 transition"
                ...
                <button className="rounded-lg w-45 h-12.5  border-[1.5px] border-[#A0C4FF] px-8 py-3.5 text-[14px] font-bold text-black bg-white hover:bg-blue-50 transition-colors shadow-sm">
                  Slot View
                </button>
              </div>
            </div>
